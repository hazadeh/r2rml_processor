...
{
    public class MyTurtleParser
    : MyIRdfReader, ITraceableParser, ITraceableTokeniser
    {
        public TokenisingParserContext context;
        //context.BaseUri;
        //context.Namespaces;
        ...
        /// </summary>
        public MyTurtleParser() { }

        /// <summary>
        /// Creates a new Turtle Parser
        /// </summary>
        /// <param name="syntax">Turtle Syntax</param>
        public MyTurtleParser(TurtleSyntax syntax) 
        {
            this._syntax = syntax;
        }
        ...
        public MyTurtleParser(TokenQueueMode queueMode)
        {
        ...
        /// <param name="queueMode">Queue Mode for Tokenising</param>
        /// <param name="syntax">Turtle Syntax</param>
        public MyTurtleParser(TokenQueueMode queueMode, TurtleSyntax syntax)
            : this(syntax)
        {
            this._queueMode = queueMode;
        }
